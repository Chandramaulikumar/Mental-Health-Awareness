...
<body>
    ...
    <form action="" class="w-50 m-auto">
        <div class="form-group row">
            <label class="align-self-center m-2">ENTER CITY</label>
            <input type="text" class="form-control w-50 align-self-center m-2" name="location" placeholder="Enter City Name">
